...
bool InstallLuaHook()
{
    ...
    static HookEntry hooks[] = {
        ...
        {0x6183F0, (LPVOID)&lua51L_checkudata,     (LPVOID*)&original_checkudata},
        {0x619630, (LPVOID)&lua51_setmetatable,    (LPVOID*)&original_setmetatable},
        {0x619060, (LPVOID)&lua51_pushinteger,     (LPVOID*)&original_pushinteger},
        {0x6197C0, (LPVOID)&lua51_pcall,           (LPVOID*)&original_pcall},
        {0x627010, (LPVOID)&lua51_resume,          (LPVOID*)&original_resume},
        {0x6194C0, (LPVOID)&lua51_settable,        (LPVOID*)&original_settable},
        {0x5BAAA0, (LPVOID)&getthreadcount,        (LPVOID*)&original_getthreadcount},
        {0x6198C0, (LPVOID)&lua51_gc,              (LPVOID*)&original_gc},
        {0x65E070, (LPVOID)&lua51c_step,           (LPVOID*)&originalc_step},
        {0x619D90, (LPVOID)&lua51_newthread,       (LPVOID*)&original_newthread},
        {0x6192A0, (LPVOID)&lua51_gettable,        (LPVOID*)&original_gettable},
        {0x619270, (LPVOID)&lua51_pushthread,      (LPVOID*)&original_pushthread},
        {0x618A50, (LPVOID)&lua51_gettop,          (LPVOID*)&original_gettop},
        {0x618A60, (LPVOID)&lua51_settop,          (LPVOID*)&original_settop},
        {0x618E50, (LPVOID)&lua51_tolstring,       (LPVOID*)&original_tolstring},
        {0x619250, (LPVOID)&lua51_pushlightuserdata,(LPVOID*)&original_plud},
        {0x619330, (LPVOID)&lua51_rawget,          (LPVOID*)&original_rawget},
        {0x618AB0, (LPVOID)&lua51_remove,          (LPVOID*)&original_remove},
        {0x619550, (LPVOID)&lua51_rawset,          (LPVOID*)&original_rawset},
        {0x618CB0, (LPVOID)&lua51_isnumber,        (LPVOID*)&original_isnumber},
        {0x618DE0, (LPVOID)&lua51_tointeger,       (LPVOID*)&original_tointeger},
        {0x618A30, (LPVOID)&lua51_atpanic,         (LPVOID*)&original_atpanic},
        {0x618C40, (LPVOID)&lua51_type,            (LPVOID*)&original_type},
        {0x619760, (LPVOID)&lua51_call,            (LPVOID*)&original_call},
        {0x62DC00, (LPVOID)&lua51_open_base,       (LPVOID*)&original_open_base},
        {0x6189E0, (LPVOID)&lua51_xmove,           (LPVOID*)&original_xmove},
        {0x619370, (LPVOID)&lua51_rawgeti,         (LPVOID*)&original_rawgeti},
        {0x6193B0, (LPVOID)&lua51_createtable,     (LPVOID*)&original_createtable},
        {0x619080, (LPVOID)&lua51_pushlstring,     (LPVOID*)&original_pushlstring},
        {0x6195C0, (LPVOID)&lua51_rawseti,         (LPVOID*)&original_rawseti},
        {0x6193F0, (LPVOID)&lua51_getmetatable,    (LPVOID*)&original_getmetatable},
        {0x618B00, (LPVOID)&lua51_insert,          (LPVOID*)&original_insert},
        {0x618B50, (LPVOID)&lua51_replace,         (LPVOID*)&original_replace},
        {0x617F10, (LPVOID)&lua51L_ref,            (LPVOID*)&originalL_ref},
        {0x617FC0, (LPVOID)&lua51L_unref,          (LPVOID*)&originalL_unref},
        {0x619040, (LPVOID)&lua51_pushnumber,      (LPVOID*)&original_pushnumber},
        {0x618DA0, (LPVOID)&lua51_tonumber,        (LPVOID*)&original_tonumber},
        {0x618CF0, (LPVOID)&lua51_isstring,        (LPVOID*)&original_isstring},
        {0x618F60, (LPVOID)&lua51_touserdata,      (LPVOID*)&original_touserdata},
        {0x618D60, (LPVOID)&lua51_lessthan,        (LPVOID*)&original_lessthan},
        {0x6199C0, (LPVOID)&lua51_next,            (LPVOID*)&original_next},
        {0x619A00, (LPVOID)&lua51_concat,          (LPVOID*)&original_concat},
        {0x618EC0, (LPVOID)&lua51_objlen,          (LPVOID*)&original_objlen},
        {0x619450, (LPVOID)&lua51_getfenv,         (LPVOID*)&original_getfenv},
        {0x6196E0, (LPVOID)&lua51_setfenv,         (LPVOID*)&original_setfenv},
        {0x617B50, (LPVOID)&lua51L_getmetafield,   (LPVOID*)&originalL_getmetafield},
        {0x6199B0, (LPVOID)&lua51_error,           (LPVOID*)&original_error},
        {0x626AD0, (LPVOID)&lua51_yield,           (LPVOID*)&original_yield},
        {0x62CA90, (LPVOID)&lua51open_string,      (LPVOID*)&original_open_string},
        {0x62AE90, (LPVOID)&lua51open_math,        (LPVOID*)&original_open_math},
        {0x62A720, (LPVOID)&lua51open_table,       (LPVOID*)&original_open_table},
        {0x628550, (LPVOID)&lua51_getinfo,         (LPVOID*)&original_getinfo},
        {0x6278D0, (LPVOID)&lua51_getstack,        (LPVOID*)&original_getstack},
        {0x5BE0A0, (LPVOID)&reportError,           (LPVOID*)&original_scriptcontextreport}, // Recheck?
        {0x628A30, (LPVOID)&lua51_close,           (LPVOID*)&original_close},
        {0x618D20, (LPVOID)&lua51_rawequal,        (LPVOID*)&original_rawequal},
        {0x618E20, (LPVOID)&lua51_toboolean,       (LPVOID*)&original_toboolean},
        {0x618C60, (LPVOID)&lua51_typename,        (LPVOID*)&original_typename},
        {0x619160, (LPVOID)&lua51_pushfstring,     (LPVOID*)&original_pushfstring},
        {0x618FB0, (LPVOID)&lua51_topointer,       (LPVOID*)&original_topointer},
        {0x6184D0, (LPVOID)&lua51L_checkany,       (LPVOID*)&originalL_checkany},
        {0x618330, (LPVOID)&lua51L_argerror,       (LPVOID*)&originalL_argerror},
        {0x619020, (LPVOID)&lua51_pushnil,         (LPVOID*)&original_pushnil},
